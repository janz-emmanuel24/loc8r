...
if (process.env.NODE_ENV === 'production') {
    apiOptions.server = 'https://salty-castle-24132.herokuapp.com';
}
...
const renderDetailPage = (req, res, location) => {
    res.render('location-info', {
        ...
        sidebar: {
            ...
            callToAction: 'If you\'ve beeen and you like it - or if you don\'t - please leave a review to help other people just like you.'
        },
        location
    });
};
